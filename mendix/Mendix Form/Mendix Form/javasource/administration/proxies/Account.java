...
public class Account extends system.proxies.User
{
	...
	{
		if (Core.isSubClassOf("MyFirstModule.Customer", mendixObject.getType()))
	...
	public static java.util.List<? extends administration.proxies.Account> load(IContext context, String xpathConstraint) throws CoreException
	{
